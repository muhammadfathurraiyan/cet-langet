  ...
  return (
    <div className="min-h-screen w-full bg-background flex flex-col items-center justify-center overflow-hidden rounded-md px-4">
      <div className="flex flex-col justify-center items-center relative">
        <h1 className="text-6xl lg:text-9xl font-bold text-center relative z-10 bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/50">
          CET LANGET
        </h1>
        <p className="text-lg text-center z-10 mt-1 max-lg:leading-5">
          Unleash the power of creativity with Cet Langet, powered by{" "}
          <a
        ...
        <div className="w-full h-full max-lg:h-[50vh] absolute top-[60px] lg:top-32">
